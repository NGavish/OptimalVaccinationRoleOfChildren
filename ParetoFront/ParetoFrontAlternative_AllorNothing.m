...
%% Parameters
collectData=false;
fname='dataParetoFront732_leaky';R0=3;betaVac=0.2;nuVac=1; effVac=0.75;
...
dataLeaky=load('dataParetoFront732_leaky_All_R=3');
%% Present Data
close all;
...
text(axVec{2},70,15,Ages{2},'fontsize',12,'color','w','fontweight','bold');
text(axVec{2},70,45,Ages{3},'fontsize',12,'color','w','fontweight','bold');
text(axVec{2},70,90,Ages{4},'fontsize',12,'color','k','fontweight','bold');
text(axVec{2},70,135,Ages{5},'fontsize',12,'color','k','fontweight','bold');
text(axVec{2},120,125,Ages{7},'fontsize',12,'color','w','fontweight','bold');
text(axVec{2},120,155,Ages{8},'fontsize',12,'color','w','fontweight','bold');
text(axVec{2},70,160,Ages{6},'fontsize',12,'color','w','fontweight','bold');
text(axVec{2},130,85,Ages{6},'fontsize',12,'color','w','fontweight','bold');

text(axVec{2},70,175,[' ',Ages{9}],'fontsize',12,'color','w','fontweight','bold');
...
printGraph('ParetoFront_allOrNone')
return
