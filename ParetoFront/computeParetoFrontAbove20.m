function computeParetoFront(susceptibilityFactor,maxPrct,VcPrct,betaVac,nuVac,effVac)
addpath('/Users/nirgavish/Dropbox (Technion Dropbox)/My Shared Functions')
addpath('../Codes/AllCountries/AuxilaryFunctions/');
vaccineRange='above20';'All';
%% Parameters
recoveredprct=0;infected_nv_prct=0;infected_v_prct=0;R0=3;
fname=['./data/dataParetoFront_susFactor=',num2str(100*susceptibilityFactor),'_maxPrct',num2str(maxPrct),'_VcPrct=',num2str(10*VcPrct),'_betaVac=',num2str(betaVac*100),'_nuVac=',num2str(10*nuVac)];
