function computeParetoFront_sqp(susceptibilityFactor,maxPrct,VcPrct,betaVac,nuVac,effVac)
...
fname=['./data_sqp/dataParetoFront_susFactor=',num2str(100*susceptibilityFactor),'_maxPrct',num2str(maxPrct),'_VcPrct=',num2str(10*VcPrct),'_betaVac=',num2str(betaVac*100),'_nuVac=',num2str(10*nuVac)];
