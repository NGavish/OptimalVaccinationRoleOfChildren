...
% "Impact of preexisting immunity on vaccination coverage required for herd immunity."
close all
...
for j_idx=1:2
    ...
    load(['./data/dataVthreshold_betaVac10_susceptibilityFactor1010recoveredPrct_',recoveredTxt{j_idx}])
    jx=j_idx;
