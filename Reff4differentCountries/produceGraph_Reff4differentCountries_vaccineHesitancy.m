function main
% This function prepares SI Figure "Effect of vaccine hesitancy on critical reproduction numbers."
...
% different vaccine hesitancy levels
M=numel(countryList);
for ix=1:M
    %% Load country data
    ...
    %% Maximum 90% vaccination in age group
    ...
    %% Maximum 80% vaccination in age group
...
for ix=2:3
    ...
    h(1).VerticalAlignment='bottom';h(1).HorizontalAlignment='center';

    h(8).VerticalAlignment='bottom';

    h(9).VerticalAlignment='top';h(9).HorizontalAlignment='center';
    ...
    h(6).VerticalAlignment='bottom';h(6).HorizontalAlignment='center';h(2).Position=h(2).Position+[0 0.2 0];
